...
<div class="container">
  ...
  <form class="row g-3" method="post" name="CreateUser" action="<?php echo base_url("createUser"); ?>">
    <div class="col-md-4">
      ...
      <input type="text" class="form-control is-valid" id="validationServer01" value="<?php echo set_value('fname'); ?>" name="fname">
    ...
    <div class="col-md-4">
      ...
      <input type="text" class="form-control is-valid" id="validationServer02" value="<?php echo set_value('lname'); ?>" name="lname">
      <div class="valid-feedback">
